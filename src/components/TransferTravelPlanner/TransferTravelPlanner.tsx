          ...
          >
            ...
            <div className={`grd-w-full grd-grid grd-group grd-grid-cols-12 grd-items-center grd-gap-4`}>
              {Object.values(TransferAmounts).map((transfer: any, index, ) => {
                ...
                return (
                  <div className={`grd-w-full grd-grid grd-items-center grd-gap-4 grd-col-span-12
                  ${ActiveTab === "return" ? isAgency ? "@lg:grd-col-span-12" : "@lg:grd-col-span-6" : isAgency ? "@lg:grd-col-span-6" : "@lg:grd-col-span-9"}`}
                       key={Math.random()} >
                    <div className={`grd-relative grd-flex grd-w-full grd-gap-4 grd-flex-col @lg:grd-flex-row`}>
              ...
              <div
                ...
                className={`input-date-time-box grd-relative grd-w-full grd-flex grd-border grd-border-gray-200 grd-rounded-lg grd-overflow-hidden 
                      grd-shadow-xs grd-text-gray-500 grd-text-base dark:grd-border-gray-800 dark:grd-text-gray-200 grd-col-span-12
                       ${ActiveTab === "return" ? isAgency ? "@lg:grd-col-span-4" : "@lg:grd-col-span-3" : isAgency ? "@lg:grd-col-span-3" : "@lg:grd-col-span-3"}
                      `}>
                <Input
                ...
                <Input
                  ...
                  leftIcon={ActiveTab === "return" ? <LIcon className={!isAgency ? "@lg:grd-hidden" : ""} size={20} name="Clock" /> : undefined}
              ...
              {ActiveTab === "return" && (
                <div
                  ...
                  className={`input-date-time-box grd-relative grd-w-full grd-flex grd-border grd-border-gray-200 grd-rounded-lg grd-overflow-hidden 
                      grd-shadow-xs grd-text-gray-500 grd-text-base dark:grd-border-gray-800 dark:grd-text-gray-200 grd-col-span-12
                      ${isAgency ? "@lg:grd-col-span-4" : "@lg:grd-col-span-3"}`}>
                  <Input
                    className="grd-border-none !grd-w-7/12"
                    inputClassName="grd-py-4 grd-pl-10"
                    iconWrapperClassName="!grd-left-3"
              ...
              {!isAgency && (
                <Input
                  className={"@lg:grd-col-span-3 grd-col-span-12"}
              ...
              <div className={`grd-flex grd-gap-4 @lg:grd-flex-row grd-flex-col grd-col-span-12
                 ${ActiveTab === "return" ? isAgency ? "@lg:grd-col-span-2" : "@lg:grd-col-span-3" : isAgency ? "@lg:grd-col-span-2" : "@lg:grd-col-span-3"}
            `}>  {/*grd-grid-cols-3*/}
                <Input
              ...
              {!isAgency && (
                <>
                  {!noReason && <Input
								    className={"grd-col-span-12 @lg:grd-col-span-3"}
								    rightIcon={<LIcon size={18} name="ChevronDown" />}
								    style={{borderRadius: design?.borderRadius}}
              ...
              <Button
                className={`grd-py-4 grd-col-span-12
                 ${ActiveTab === "return" ? isAgency ? "@lg:grd-col-span-2" : "@lg:grd-col-span-3" : isAgency ? "@lg:grd-col-span-1" : "@lg:grd-col-span-3"}
              `}
                variant="primary"
                style={{
                  ...design?.button,
